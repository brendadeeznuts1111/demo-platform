...
<head>
    ...
    <style>
        ...
        .header p { font-size: 1.2em; color: #94a3b8; }
        ...
        .status { display: inline-block; padding: 4px 12px; border-radius: 20px; font-size: 0.9em; background: #22c55e; color: white; }
        .button { background: #3b82f6; color: white; border: none; padding: 10px 20px; border-radius: 6px; cursor: pointer; margin: 5px; }
        .button:hover { background: #2563eb; }
        #messages { max-height: 300px; overflow-y: auto; background: #0f172a; padding: 10px; border-radius: 6px; margin: 10px 0; border: 1px solid #334155; }
        .message { padding: 8px; margin: 4px 0; background: #1e293b; border-radius: 4px; font-family: monospace; }
        .feature-list { list-style: none; padding: 0; }
        .feature-list li { padding: 4px 0; border-bottom: 1px solid #334155; }
